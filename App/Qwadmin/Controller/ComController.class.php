...
class ComController extends BaseController
{
    ...
    public function _initialize()
    {
        ...
        $pclogo = M('setting')->where("k='pclogo'")->find();
        $this->assign('pclogo', $pclogo);
    ...
    public function xgshebei($shebeiid)
    {
        //获取巡更地点方法
        $name = M('xgshebei')->field('name')->where(" id = '{$shebeiid}'")->find();
        return $name;
    }
    ...
    protected function getMenus($items, $id = 'id', $pid = 'parentid', $son = 'children')
    {
        $tree   = array();
        $tmpMap = array();
