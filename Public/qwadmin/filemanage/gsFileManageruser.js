...
gs_filemanager_languages['en'][18] = '下载';
gs_filemanager_languages['en'][19] = '删除';
gs_filemanager_languages['en'][20] = '打开';
...
gs_filemanager_languages['en'][28] = '取消';
gs_filemanager_languages['en'][29] = '上传文件';
...
gs_filemanager_languages['en'][37] = '文件夹命名';
...
gs_filemanager_languages['en'][45] = '添加上传选项';
gs_filemanager_languages['en'][46] = '移除';
...
// <td><div style="text-align: right; padding-right: 20px;"><a href=\'javascript: void(0);\' onClick=\'return gs_showClipboardContent();\' class=\'gs_dir_content_button\'>&nbsp;' + gs_getTranslation(o.language, 2)+ '&nbsp;</a><span id=\'gsClipBoard\'>0 items</span></div></td>			
			var menuHtml = '<table class=\'gsHeadTable\' cellpadding=0 cellspacing=0><tr><td><span class=\'gsHeadText\'> ' + gs_getTranslation(o.language, 1)+ ': </span><span id=\'curDir\'></span></td></tr></table><br/>';
			...
			jQuery('#gs_uploadAddField').click(function (e){
				...
				uploadsFieldsHolder.append('<div><a onClick="jQuery(this).parent().remove();" style="font-size: 12px" class=\'gs_dir_content_button removebutton\'>&nbsp;' + gs_getTranslation(o.language, 46)+ '&nbsp;</a> <input type="file" name="filename_' + uploadsFieldsLength + '" size="30"/></div><div style="Clear:both"></div>');
			});
			...
			function showDirs (gsfiless) {
				...
				if (gs_lastparent.length > 0) {
				    fileshtml += "<tr><td></td><td><div class='directory directory_info gsItem' rel=\'up\'><a href='javascript:void(0)' ondblclick=\"jQuery('#" + jQuery("#curDir").attr('rel')+ "').parent().parent().parent().children('a').trigger('click'); return false\"> ..返回上一级</a></div></td><td>Dir</td></tr>";
				}
				if (gsfiless.length > 0) {
